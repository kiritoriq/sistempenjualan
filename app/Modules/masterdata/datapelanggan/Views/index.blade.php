<section class="content-header">
    <h1>
        Datapelanggan<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li class="active">Datapelanggan</li>
    </ol>
</section>
    ...
    <div class="box box-primary">
        ...
        <div class="table-responsive">
            <div class="box-body no-padding">
                <table class="table table-striped table-hover table-condensed table-bordered" id='tabel'>
                    ...
                    <tr>
                        <td><center>{!! ClaravelHelpers::ckDelete($datapelanggan->id); !!}</center></td>
                        					<td>{!!$datapelanggan->no_plg!!}</td>
					<td>{!!$datapelanggan->nama_plg!!}</td>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li>{!! ClaravelHelpers::btnEdit($datapelanggan->id) !!}</li>
                                    <li>{!! ClaravelHelpers::btnDelete($datapelanggan->id) !!}</li>
                                </ul>
                            </div>
                        </td>
                    </tr>
        ...
        <div class="box-footer clearfix">
          <div class="row">
            ...
            <div class="col-sm-6">
              <?php echo $datapelanggans->appends(array('search' => Input::get('search')))->render(); ?>
            </div>
          </div>
        </div>
        {!! Form::close() !!}
