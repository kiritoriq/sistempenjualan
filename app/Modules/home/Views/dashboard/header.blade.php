...
<!--CKEDITOR-->
<script type="text/javascript" src="{{asset('packages/tugumuda/plugins/editor/ckeditor.js')}}"></script>
<script type="text/javascript" src="{{asset('packages/tugumuda/plugins/editor/adapters/jquery.js')}}"></script>
<!--CKEDITOR-->

<!-- fileinput -->    
	<link rel="stylesheet" href="{{ asset('packages/tugumuda/css/fileinput.min.css') }}" />    
	<script type="text/javascript" src="{{ asset('packages/tugumuda/js/fileinput.min_optimized.js') }}"></script>   
<!-- fileinput -->
...
<script type="text/javascript" src="{{ asset('packages/tugumuda/plugins/chartjs/highcharts.js') }}"></script>
<script type="text/javascript" src="{{ asset('packages/tugumuda/plugins/chartjs/data.js') }}"></script>
<script type="text/javascript" src="{{ asset('packages/tugumuda/plugins/chartjs/exporting.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('packages/tugumuda/js/jquery-ui.min.js')}}"></script>
<script type="text/javascript" src="{{ asset('packages/tugumuda/plugins/number/jquery.number.min.js')}}"></script>
...
<!--          <li class="dropdown notifications-menu">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">                
                <span class="hidden-xs"><i class="fa fa-user"></i> {{session('name')}}</span>
            </a>
