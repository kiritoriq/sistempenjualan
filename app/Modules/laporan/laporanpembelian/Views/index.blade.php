<?php
    ...
    $barang = \DB::table('tb_barang_inout')
            ...
            ->select('tb_barang_inout.*','mast_barang.nm_barang','mast_barang.hrg_beli')
...
<section class="content-header">
    <h1>
        Laporanpembelian<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li class="active">Laporanpembelian</li>
    </ol>
</section>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#prosesbulan').on('click',function(e){
            ...
            // alert(bulan);
            $.ajax({
                url: '{{url()}}/laporan/laporanpembelian/data',
                type: 'POST',
